...
// import { Shield, BookOpen, Lightbulb, MessageSquare, FileText, Scale, Bell, Monitor, Heart, Book, Users, FileSpreadsheet, FileText as FileText2, Users2 } from 'lucide-react';
...
//   { icon: FileText2, title: 'GACETA OFICIAL', description: 'Publicaciones institucionales' },
...
//               key={index}
//               href="#"
//               className="group p-6 bg-gray-50 rounded-lg hover:bg-primary hover:text-white transition-all duration-300 transform hover:-translate-y-1"
//             >
//               <div className="flex flex-col items-center text-center">
//                 <service.icon className="h-8 w-8 text-primary group-hover:text-white mb-4" />
//                 <h3 className="text-sm font-semibold mb-2">{service.title}</h3>
//                 <p className="text-sm text-gray-600 group-hover:text-gray-200">{service.description}</p>
//               </div>
//             </a>
//           ))}
//         </div>
  ...
  return (
    <section className="py-16 bg-gray-100">
      <div className="container mx-auto px-4 lg:pl-8">
        <h2 className="text-3xl font-bold text-center lg:text-left mb-12 text-primary">
          Noticias y Eventos
        </h2>
...
// Wrapper component to use in your page
export function ServiceNewsWrapper() {
  return (
